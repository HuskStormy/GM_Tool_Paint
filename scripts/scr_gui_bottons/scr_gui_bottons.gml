...
function button_gui_draw(_button_gui_id, _spr_icon = pointer_null) {
	...
	if (_spr_icon != pointer_null) draw_sprite_stretched(_spr_icon, 0, b.x, b.y, b.width, b.height)	
...
function button_gui_draw_sprite(_button_gui_id, _sprite, _sprite_outline = pointer_null, _spr_icon = pointer_null, _img_free = 0, _img_select = 1, _img_press = 2) {
    var b = _button_gui_id;
