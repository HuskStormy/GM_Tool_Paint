...
var point = point_in_rectangle(mouse_x, mouse_y, _x, _y, _w, _h);
...
if (variable_global_exists("pincel") and mouse_check_button(mb_left) and !scr_bottonGUI_get_fromMouse() and point){
